...
def main():
    ...
    prefix = 'CT22_claim/policlaim_context'
    train_ids, train_tweets, train_labels = load_data(prefix + "_train.csv")
    train_ids, val_ids, train_tweets, val_tweets, train_labels, val_labels = train_test_split(
        train_ids, train_tweets, train_labels,
        test_size=0.1,
        random_state=42,
        stratify=train_labels
    )
    test_ids, test_tweets, test_labels = load_data(prefix + "_test.csv")
    ...
    evaluation_file = "../evaluation_results/t_best_param_roberta_web4good_policlaim.csv"
